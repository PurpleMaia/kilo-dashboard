...
var LLMClient = /** @class */ (function () {
     ...
     */
    LLMClient.getInstance = function () {
        if (!this.instance) {
     ...
     */
    LLMClient.makeRequest = function (messages_1) {
                ...
                switch (_f.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, client.chat.completions.create({
                                ...
                                max_tokens: (_b = options.maxTokens) !== null && _b !== void 0 ? _b : 1000,
                            })];
                    case 2:
                        response = _f.sent();
                        return [2 /*return*/, ((_e = (_d = (_c = response.choices[0]) === null || _c === void 0 ? void 0 : _c.message) === null || _d === void 0 ? void 0 : _d.content) === null || _e === void 0 ? void 0 : _e.trim()) || ''];
                    case 3:
                        error_1 = _f.sent();
                        console.error('LLM request failed:', error_1);
                        throw new Error("LLM request failed: ".concat(error_1 instanceof Error ? error_1.message : 'Unknown error'));
